...
//
 ...
 //   let recipesResponseModel = try? newJSONDecoder().decode(RecipesResponseModel.self, from: jsonData)

import Foundation

// MARK: - RecipesResponseModelElement
struct RecipesResponseModelElement: Codable {
    ...
    var recipesResponseModelDescription: String?
    var highlighted: Bool?
    var ingredients: [String]?
    var incompatibilities: JSONNull?
    var deliverableIngredients: [String]?
    var undeliverableIngredients: [JSONAny]?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case recipesResponseModelDescription = "description"
...
typealias RecipesResponseModel = [RecipesResponseModelElement]
